	...
	<div class="t_news t_sitemap t_blog t_full t_gallery t_search t_login t_contact t_portfolio post_edit_page t_default">
		...
		<div style="margin: 13px 0 11px 4px;" class="t_news t_sitemap t_blog t_gallery t_search t_login t_contact t_portfolio post_edit_page t_default">
			<label>
			<input type="checkbox" name="_web_business_meta[fullwidthpage]" <?php checked($meta['fullwidthpage'], "on"); ?> />
			Full Width Page</label><br/>
		</div>
		
		<div style="margin: 13px 0 11px 4px;" class="t_blog t_news">
			<label>
			<input type="checkbox" name="_web_business_meta[blogstyle]" <?php checked($meta['blogstyle'], "on"); ?> />
			Blog Style mode</label><br/>
		</div>
		
		<div style="margin: 13px 0 11px 4px;" class="t_news t_blog">
			<label>
		...
		<div style="margin: 13px 0 11px 4px;" class="t_news t_blog t_portfolio t_gallery">
		...
		<div style="margin: 13px 0 11px 4px;" class="t_sitemap">
		    <?php if(isset($meta['blog_posts_on']))
				$meta_blog=$meta['blog_posts_on']; 
			  else	
			    $meta_blog='';
			  ?>
			<input style="margin-right: 10px;" type="checkbox" name="_web_business_meta[blog_posts_on]" <?php checked($meta_blog, "on") ?> />
